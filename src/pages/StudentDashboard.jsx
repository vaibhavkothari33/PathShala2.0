...
const StudentDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      ...
      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-200/80 shadow-sm">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            >
              ...
              {userLocation && (
                <motion.div
                  ...
                  className="flex items-center px-4 py-2 bg-blue-50/80 backdrop-blur-sm rounded-full text-blue-600 border border-blue-100"
                >
            ...
            <div className="flex items-center space-x-4">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl hover:from-indigo-700 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg"
              >
                <BookOpen className="h-5 w-5 mr-2" />
                <span className="font-medium">My Enrolled Courses</span>
              </motion.button>
            </div>
          </div>
        </div>
        ...
        >
          <div className="relative flex-1">
            <div className="relative group">
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-indigo-500 transition-colors duration-200" />
              <input
                type="text"
                placeholder="Search by name, subject, or location..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-12 pr-4 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white/80 backdrop-blur-sm shadow-sm hover:border-indigo-300 transition-all duration-200 text-gray-700 placeholder-gray-400"
              />
            </div>
          </div>
          ...
          <motion.button
            ...
            className="flex items-center justify-center px-5 py-3.5 border border-gray-200 rounded-xl bg-white/80 backdrop-blur-sm hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow-md group"
          >
            <Filter className="h-5 w-5 mr-2 text-indigo-600 group-hover:text-indigo-700" />
            <span className="font-medium text-gray-700">Filters</span>
            <ChevronDown className={`h-4 w-4 ml-2 transform transition-transform duration-300 ${showFilters ? 'rotate-180' : ''} text-gray-500`} />
          </motion.button>
        </motion.div>
        ...
        <AnimatePresence>
          {showFilters && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -20 }}
              className="mt-4 p-6 bg-white/80 backdrop-blur-lg rounded-xl shadow-lg border border-gray-100"
            >
        ...
        {loading ? (
          <div className="mt-16 flex flex-col items-center justify-center">
            <motion.div
              animate={{ 
                rotate: 360,
                borderColor: ['#4f46e5', '#3b82f6', '#4f46e5']
              }}
              transition={{ 
                duration: 1.5,
                repeat: Infinity,
              ...
              className="h-16 w-16 border-4 border-t-indigo-600 rounded-full"
            />
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              Finding the best coaching centers...
            </motion.p>
          </div>
          ...
          >
            ...
            <h3 className="mt-4 text-xl font-semibold text-gray-900">No coaching centers found</h3>
          ...
          >
            {filteredCenters.map((center, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="group bg-white/80 backdrop-blur-sm rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100"
              >
                <div className="relative h-52 rounded-t-xl overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center">
                    ...
                    <div className="px-4 py-1.5 bg-white/90 backdrop-blur-sm rounded-full text-indigo-600 font-medium">
                      {center.price}/month
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-2">
                      <div className="flex items-center px-3 py-1 bg-yellow-50 rounded-full">
                        ...
                        <span className="ml-1 font-medium text-yellow-700">{center.rating}</span>
                      </div>
                      {center.reviews > 0 && (
                  ...
                  <div className="space-y-3 mb-6">
                    {center.location && (
                      <div className="flex items-center text-gray-600 group">
                        ...
                        <span className="ml-3 text-sm">{center.location}</span>
                      </div>
                    )}
                    {center.availability && (
                      <div className="flex items-center text-gray-600 group">
                        ...
                        <span className="ml-3 text-sm">{center.availability}</span>
                      </div>
                    )}
                  </div>
                  ...
                  {/* View Details Button */}
                  <Link to={`/coaching/${center.slug}`}>
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="w-full flex items-center justify-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl hover:from-indigo-700 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg group"
                    >
